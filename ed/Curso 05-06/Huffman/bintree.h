...
/*
  $Id: bintree.h,v 1.3 2006/05/22 20:58:19 jmbs Exp $  
*/
/*
  $Log: bintree.h,v $
  Revision 1.3  2006/05/22 20:58:19  jmbs
  - Corregido error en bintree<T>::operator=
  - Incluida implementaciÃ³n de operator= para todos los iteradores
